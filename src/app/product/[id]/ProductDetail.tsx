...
import { HiShoppingCart, HiArrowLeft, HiDownload, HiTag } from "react-icons/hi";
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            >
              ...
              <button onClick={handleBuyNow} className="btn-primary flex-1 text-lg py-3.5">
            ...
            >
              <p className="text-dark-500 text-xs leading-relaxed">
                <strong className="text-dark-400">Secure checkout:</strong> Your payment is
                processed through Stripe. We never store your credit card details.
              </p>
            </motion.div>
          </motion.div>
        </div>
